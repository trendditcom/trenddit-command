...
This Streamlit app provides a user-friendly interface for scraping web articles and saving them as markdown files. It utilizes the `trenddit-command.gather` module to perform the scraping functionality.
...
pip install streamlit trenddit-command requests beautifulsoup4 html2text readability-lxml robotexclusionrulesparser markdown2 rich
...
import trenddit-command.gather as gather
import trenddit-command.configure as configure
import os
