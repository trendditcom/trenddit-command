## Trenddit to Streamlit

Your job is to create Streamlit app based on code from a module of trenddit-command package.
...
2. Read the Trenddit API Documentation.
3. Think of how to represent the module code as features in the app.
4. Think about enabling the same functionality as provided by this module while importing and using the trenddit-command package API.
