...
from trenddit_command.metrics import (count_tokens, create_sparkline, display_trends,
...
@patch("trenddit_command.metrics.generate_yaml_data")
@patch("trenddit_command.metrics.save_to_yaml")
...
def test_process_data():
    ...
    with patch("trenddit_command.metrics.datetime") as mock_datetime:
