...
from trenddit_command.bedrock import Bedrock
from trenddit_command.claude import Claude
from trenddit_command.gemini import Gemini
from trenddit_command.groq import Groq
from trenddit_command.ollama import Ollama
from trenddit_command.openai import Openai
from trenddit_command.perplexity import Perplexity
from trenddit_command.utils import get_provider_instance, trail
...
def test_trail_decorator():
    ...
    with patch("trenddit_command.utils.datetime", mock_datetime), patch(
        "trenddit_command.utils.open", mock_open()
...
def test_trail_decorator_with_string_result():
    ...
    with patch("trenddit_command.utils.open", mock_open()) as mock_file, patch(
        "yaml.dump"
